...
namespace reaver
{
    inline namespace prelude { inline namespace monad { inline namespace _v1
    {
        template<typename Vector, typename std::enable_if<
            is_vector<std::remove_cv_t<std::remove_reference_t<Vector>>>::value
